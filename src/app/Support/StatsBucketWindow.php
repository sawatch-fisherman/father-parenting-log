 ...
 *
 * バケットの境界は JST の暦日・暦週・暦月で切り、**週は月曜始まり**（`Carbon::MONDAY`〜
 * `Carbon::SUNDAY`）とする（`docs/decisions.md` §1.3「S12 集計グラフの仕様」）。
 * 基準日（`base_date`）は「その週／月に属する任意の日」として扱われ、前後の期間送りは
 * 基準日を7週・7か月ぶん動かすだけで正しいバケットに着地する。
 */
